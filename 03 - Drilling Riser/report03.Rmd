...
Será seguido o caminho com a análise de variância em virtude da possível economia e do possível menor custo com a amostragem, caso o ANOVA venha a identificar alguma diferença entre as configurações possíveis de _risers_.
...
Como pode ser observado, o gráfico anterior não indica visualmente diferença significativa entre os níveis. Corrobora com isto, o _F-valor = 0.608_ do teste ANOVA indicando pela não rejeição da hipótese de que não há diferença entre os grupos.

Este resultado também indica que não há necessidade de testes de comparação múltiplas, que poderiam identificar quais os níveis diferentes do grupo de controle _(Riser1)_.
